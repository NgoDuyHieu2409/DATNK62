...
<head>
	...
	<link href="https://fonts.googleapis.com/css?family=Montserrat:300,400,500,600,700,800,900%7CPlayfair+Display:400,700,900" rel="stylesheet">
			...
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="{{route('dashboard')}}">
						<img src="images/logo.png" alt="Logo" style="width: 200px;margin-top: -12px;" />
					</a>
				...
				<div class="navbar-collapse collapse" id="navigation">
					<ul class="nav navbar-nav navbar-right main-navigation" id="main-menu">
						...
						<li><a href="php/admin.php">Đăng nhập</a></li>
					</ul>
				</div>
